	...
	<div class="toolbar">
		...
		<div class="toolbar__right">
			<Tooltip text="Fullscreen">
				<div class="icon" on:click={requestFullscreen} on:keypress={handleKeypress(requestFullscreen)}>
			...
			{#if $currentUser && $currentUser.isAuthenticated}
				<Tooltip text="Sign out">
					<div class="icon" on:click={handleSignOut} on:keypress={handleKeypress(handleSignOut)}>
						<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							<path
								fill="currentColor"
			...
			{:else}
				<Tooltip text="Sign in">
					<div class="icon" on:click={handleSignIn} on:keypress={handleKeypress(handleSignIn)}>
						<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							<path
								fill="currentColor"
